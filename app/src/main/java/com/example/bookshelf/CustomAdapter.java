    ...
    public void onBindViewHolder(@NonNull CustomAdapter.MyViewHolder holder, int position) {
        ...
        holder.mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("id", String.valueOf(book_id.get(actualposition)));
                intent.putExtra("title", String.valueOf(book_title.get(actualposition)));
                intent.putExtra("author", String.valueOf(book_author.get(actualposition)));
                intent.putExtra("pages", String.valueOf(book_pages.get(actualposition)));
